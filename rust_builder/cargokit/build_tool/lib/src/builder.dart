...
class BuildEnvironment {
  ...
  String toString() {
    ...
    return 'BuildEnvironment(configuration: $configuration, crateOptions: $crateOptions, targetTempDir: $targetTempDir, manifestDir: $manifestDir, crateInfo: $crateInfo, isAndroid: $isAndroid, androidSdkPath: $androidSdkPath, androidNdkVersion: $androidNdkVersion, androidMinSdkVersion: $androidMinSdkVersion, javaHome: $javaHome)';
  }
}
...
class RustBuilder {
  ...
  @override
  String toString() {
    return 'RustBuilder(target: $target, environment: $environment)';
  }
}
