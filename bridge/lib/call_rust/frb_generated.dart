...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => -131517600;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<void> crateFileUntreatedVideoDataCancel(
      {required UntreatedVideoData that});

  Future<List<UntreatedVideo>> crateFileUntreatedVideoDataGetVideos(
      {required UntreatedVideoData that});

  Future<BigInt> crateFileUntreatedVideoDataGetVideosSize(
      {required UntreatedVideoData that});

  Future<UntreatedVideoData> crateFileUntreatedVideoDataNewInstance();

  void crateFileUntreatedVideoDataSetTextFilter(
      {required UntreatedVideoData that, required String text});

  List<Source> crateFileUntreatedVideoDataSources(
      {required UntreatedVideoData that});

  String crateFileUntreatedVideoDataTextFilter(
      {required UntreatedVideoData that});

  Future<String?> crateFileUntreatedVideoDataUnwatchSourceF(
      {required UntreatedVideoData that,
      required Source source,
      required bool syncDelete});

  Future<String?> crateFileUntreatedVideoDataWatchSourcePathStringF(
      {required UntreatedVideoData that, required String path});

  String crateModelSourceSourcePath({required Source that});
  ...
  Future<List<UntreatedVideo>> crateNativeDbApiGetUntreatedVideos();
  ...
  String? crateNativeSystemApiCheckCrawlerTemplate({required String raw});

  Future<String?> crateNativeSystemApiDeleteCrawlerTemplate({required int id});
  ...
  String crateNativeSystemApiGetRoamingPath();

  bool crateNativeSystemApiGetScanStorageStatus();

  Future<TaskConfig> crateNativeSystemApiGetTaskConf();

  Future<void> crateNativeSystemApiImportCrawlerTemplate(
      {required String raw,
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_UntreatedVideoData;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_UntreatedVideoData;

  CrossPlatformFinalizerArg
      get rust_arc_decrement_strong_count_UntreatedVideoDataPtr;
}
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  Future<void> crateFileUntreatedVideoDataCancel(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        final serializer = SseSerializer(generalizedFrbRustBinding);
        sse_encode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
            that, serializer);
      ...
      constMeta: kCrateFileUntreatedVideoDataCancelConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataCancelConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_cancel",
        argNames: ["that"],
      );
  ...
  Future<List<UntreatedVideo>> crateFileUntreatedVideoDataGetVideos(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataGetVideosConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataGetVideosConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_get_videos",
        argNames: ["that"],
      );
  ...
  Future<BigInt> crateFileUntreatedVideoDataGetVideosSize(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataGetVideosSizeConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataGetVideosSizeConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_get_videos_size",
        argNames: ["that"],
      );
  ...
  Future<UntreatedVideoData> crateFileUntreatedVideoDataNewInstance() {
    return handler.executeNormal(NormalTask(
      ...
      codec: SseCodec(
        decodeSuccessData:
            sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData,
        decodeErrorData: sse_decode_AnyhowException,
      ),
      constMeta: kCrateFileUntreatedVideoDataNewInstanceConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataNewInstanceConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_new_instance",
        argNames: [],
      );
  ...
  void crateFileUntreatedVideoDataSetTextFilter(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataSetTextFilterConstMeta,
      argValues: [that, text],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataSetTextFilterConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_set_text_filter",
        argNames: ["that", "text"],
      );
  ...
  List<Source> crateFileUntreatedVideoDataSources(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataSourcesConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataSourcesConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_sources",
        argNames: ["that"],
      );
  ...
  String crateFileUntreatedVideoDataTextFilter(
    ...
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataTextFilterConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataTextFilterConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_text_filter",
        argNames: ["that"],
      );
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerSource(
            source, serializer);
        sse_encode_bool(syncDelete, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateFileUntreatedVideoDataUnwatchSourceFConstMeta,
      argValues: [that, source, syncDelete],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateFileUntreatedVideoDataUnwatchSourceFConstMeta =>
      const TaskConstMeta(
        debugName: "UntreatedVideoData_unwatch_source_f",
        argNames: ["that", "source", "syncDelete"],
      );
  ...
  Future<String?> crateFileUntreatedVideoDataWatchSourcePathStringF(
    ...
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateFileUntreatedVideoDataWatchSourcePathStringFConstMeta,
      argValues: [that, path],
      apiImpl: this,
    ));
  }
  ...
  TaskConstMeta
      get kCrateFileUntreatedVideoDataWatchSourcePathStringFConstMeta =>
          const TaskConstMeta(
            debugName: "UntreatedVideoData_watch_source_path_string_f",
            argNames: ["that", "path"],
          );
  ...
  String crateModelSourceSourcePath({required Source that}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateModelSourceSourcePathConstMeta,
      argValues: [that],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateModelSourceSourcePathConstMeta => const TaskConstMeta(
        debugName: "Source_path",
        argNames: ["that"],
      );
  ...
  Future<List<UntreatedVideo>> crateNativeDbApiGetUntreatedVideos() {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateNativeDbApiGetUntreatedVideosConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateNativeDbApiGetUntreatedVideosConstMeta =>
      const TaskConstMeta(
        debugName: "get_untreated_videos",
        argNames: [],
      );
  ...
  String? crateNativeSystemApiCheckCrawlerTemplate({required String raw}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateNativeSystemApiCheckCrawlerTemplateConstMeta,
      argValues: [raw],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateNativeSystemApiCheckCrawlerTemplateConstMeta =>
      const TaskConstMeta(
        debugName: "check_crawler_template",
        argNames: ["raw"],
      );
  ...
  Future<String?> crateNativeSystemApiDeleteCrawlerTemplate({required int id}) {
    return handler.executeNormal(NormalTask(
      ...
      constMeta: kCrateNativeSystemApiDeleteCrawlerTemplateConstMeta,
      argValues: [id],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateNativeSystemApiDeleteCrawlerTemplateConstMeta =>
      const TaskConstMeta(
        debugName: "delete_crawler_template",
        argNames: ["id"],
      );
  ...
  String crateNativeSystemApiGetRoamingPath() {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateNativeSystemApiGetRoamingPathConstMeta,
      argValues: [],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateNativeSystemApiGetRoamingPathConstMeta =>
      const TaskConstMeta(
        debugName: "get_roaming_path",
        argNames: [],
      );
  ...
  Future<void> crateNativeSystemApiImportCrawlerTemplate(
    ...
    return handler.executeNormal(NormalTask(
      callFfi: (port_) {
        ...
        sse_encode_String(searchUrl, serializer);
        pdeCallFfi(generalizedFrbRustBinding, serializer,
      ...
      constMeta: kCrateNativeSystemApiImportCrawlerTemplateConstMeta,
      argValues: [raw, baseUrl, searchUrl],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateNativeSystemApiImportCrawlerTemplateConstMeta =>
      const TaskConstMeta(
        debugName: "import_crawler_template",
        argNames: ["raw", "baseUrl", "searchUrl"],
      );
  ...
  RustArcIncrementStrongCountFnType
      get rust_arc_increment_strong_count_UntreatedVideoData => wire
          .rust_arc_increment_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData;

  RustArcDecrementStrongCountFnType
      get rust_arc_decrement_strong_count_UntreatedVideoData => wire
          .rust_arc_decrement_strong_count_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData;
  ...
  @protected
  UntreatedVideoData
      dco_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  @protected
  UntreatedVideoData
      dco_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  @protected
  UntreatedVideoData
      dco_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalDcoDecode(raw as List<dynamic>);
  }
  ...
  UntreatedVideoData
      sse_decode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  }
  ...
  @protected
  UntreatedVideoData
      sse_decode_Auto_Ref_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  ...
  @protected
  UntreatedVideoData
      sse_decode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    return UntreatedVideoDataImpl.frbInternalSseDecode(
        sse_decode_usize(deserializer), sse_decode_i_32(deserializer));
  ...
  @protected
  void
      sse_encode_Auto_Owned_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          UntreatedVideoData self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as UntreatedVideoDataImpl).frbInternalSseEncode(move: true),
        serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as SourceImpl).frbInternalSseEncode(move: false), serializer);
  }
  ...
  void
    ...
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as UntreatedVideoDataImpl).frbInternalSseEncode(move: false),
        serializer);
  }
  ...
  @protected
  void
      sse_encode_RustOpaque_flutter_rust_bridgefor_generatedRustAutoOpaqueInnerUntreatedVideoData(
          UntreatedVideoData self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_usize(
        (self as UntreatedVideoDataImpl).frbInternalSseEncode(move: null),
        serializer);
  }
...
class SourceImpl extends RustOpaque implements Source {
  ...
  String get path => RustLib.instance.api.crateModelSourceSourcePath(
        that: this,
      );
}
...
@sealed
class UntreatedVideoDataImpl extends RustOpaque implements UntreatedVideoData {
  // Not to be used by end users
  UntreatedVideoDataImpl.frbInternalDcoDecode(List<dynamic> wire)
      : super.frbInternalDcoDecode(wire, _kStaticData);

  // Not to be used by end users
  UntreatedVideoDataImpl.frbInternalSseDecode(
      BigInt ptr, int externalSizeOnNative)
      : super.frbInternalSseDecode(ptr, externalSizeOnNative, _kStaticData);

  static final _kStaticData = RustArcStaticData(
    rustArcIncrementStrongCount:
        RustLib.instance.api.rust_arc_increment_strong_count_UntreatedVideoData,
    rustArcDecrementStrongCount:
        RustLib.instance.api.rust_arc_decrement_strong_count_UntreatedVideoData,
    rustArcDecrementStrongCountPtr: RustLib
        .instance.api.rust_arc_decrement_strong_count_UntreatedVideoDataPtr,
  );

  Future<void> cancel() =>
      RustLib.instance.api.crateFileUntreatedVideoDataCancel(
        that: this,
      );

  Future<List<UntreatedVideo>> getVideos() =>
      RustLib.instance.api.crateFileUntreatedVideoDataGetVideos(
        that: this,
      );

  Future<BigInt> getVideosSize() =>
      RustLib.instance.api.crateFileUntreatedVideoDataGetVideosSize(
        that: this,
      );

  set textFilter(String text) => RustLib.instance.api
      .crateFileUntreatedVideoDataSetTextFilter(that: this, text: text);

  List<Source> get sources =>
      RustLib.instance.api.crateFileUntreatedVideoDataSources(
        that: this,
      );

  String get textFilter =>
      RustLib.instance.api.crateFileUntreatedVideoDataTextFilter(
        that: this,
      );

  Future<String?> unwatchSourceF(
          {required Source source, required bool syncDelete}) =>
      RustLib.instance.api.crateFileUntreatedVideoDataUnwatchSourceF(
          that: this, source: source, syncDelete: syncDelete);

  Future<String?> watchSourcePathStringF({required String path}) =>
      RustLib.instance.api.crateFileUntreatedVideoDataWatchSourcePathStringF(
          that: this, path: path);
}
